...
class VetClinicApp:
    ...
    def setup_aba_recepcao(self):
        ...
        self.list_agendamentos = self._create_listbox(self.frame_agendamentos, height_val=20, font_size=9) # Fonte ajustada
        ...
        self.list_atendimento = self._create_listbox(self.frame_atendimento, height_val=20, font_size=9) # Fonte ajustada
        ...
        self.list_finalizadas = self._create_listbox(self.frame_finalizadas, height_val=20, font_size=9) # Fonte ajustada
    ...
    def _create_column_frame(self, parent, col, title):
        ...
        # 🟣 Frame Roxo para simular a Borda do Título 🟣
    ...
    def _create_listbox(self, parent, height_val=15, font_size=10):
        # 💥 ALTERAÇÃO: Trocando a fonte de "Courier" para "Arial" 💥
        listbox = tk.Listbox(parent, 
                             height=height_val, 
                             font=("Arial", font_size), # << AQUI ESTÁ A MUDANÇA
    ...
    def setup_aba_veterinario(self):
        ...
        tk.Label(login_center, text="Usuário:", bg="white").grid(row=1, column=0, sticky="w", pady=5)
        self.vet_user_entry = ttk.Entry(login_center, width=20)
        self.vet_user_entry.grid(row=1, column=1, pady=5, padx=5)
        
        tk.Label(login_center, text="Senha:", bg="white").grid(row=2, column=0, sticky="w", pady=5)
        ...
        # Listbox com fonte "Arial"
        self.vet_consulta_list = self._create_listbox(list_card_frame, height_val=12, font_size=9) # Fonte ajustada
        ...
        # 💥 ALTERAÇÃO: Text Widget com fonte "Arial" e cor de seleção roxa 💥
        self.relatorio_text = tk.Text(report_card_frame, 
                                      height=30, 
                                      width=80, 
                                      font=("Arial", 9), # << AQUI ESTÁ A MUDANÇA
                                      wrap="word", 
                                      bd=0, 
                                      highlightthickness=0,
                                      selectbackground=self.cor_selecao,
